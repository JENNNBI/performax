...
import 'problem_solving_grade_selection_screen.dart';

/// Problem Solving Subjects Panel Screen
/// Shows all subjects for Soru Çözümü section
class ProblemSolvingSubjectsScreen extends StatefulWidget {
  static const String id = 'problem_solving_subjects_screen';
  
  const ProblemSolvingSubjectsScreen({super.key});

  @override
  State<ProblemSolvingSubjectsScreen> createState() => _ProblemSolvingSubjectsScreenState();
}

class _ProblemSolvingSubjectsScreenState extends State<ProblemSolvingSubjectsScreen>
      ...
      builder: (context, languageState) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              languageBloc.currentLanguage == 'tr' ? 'Soru Çözümü' : 'Problem Solving',
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                bottom: 15,
                child: Hero(
                  tag: 'problem_solving_icon_$title',
                  child: Image.asset(
                    iconAsset,
                    height: 110,
                    width: 110,
  ...
  void _navigateToSubject(BuildContext context, String subjectKey, LanguageBloc languageBloc) {
    ...
    Navigator.push(
      context,
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) => ProblemSolvingGradeSelectionScreen(
